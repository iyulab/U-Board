# U-Board Individual Contributor License Agreement (v1)

U-Board is dual-licensed: AGPL-3.0 for open-source use, and a separate commercial license for
...
- **"Submit"** means any form of communication sent to iyulab or its representatives, including
  pull requests, issues, patches and discussion on any medium used to manage U-Board, excluding
...
iyulab to distribute and sublicense Your Contribution — on its own or as part of U-Board, in
...
Contribution, or U-Board to which You contributed, constitutes direct or contributory patent
...
3. Use this content, filled in:
   ...
   I have read the U-Board Individual Contributor License Agreement v1 (`CLA.md`) and I agree to
   it for all of my contributions to U-Board, past and future.
